...
class Metaclass_Slam(type):
    """Metaclass of message 'Slam'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__slam
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__slam
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__slam
...
class Slam(metaclass=Metaclass_Slam):
    """Message class 'Slam'."""
...
=======
    ...
    _fields_and_field_types = {
        ...
        'point_cloud': 'sensor_msgs/PointCloud2',
        'transform_init2cur': 'geometry_msgs/PoseStamped',
    }
...
=======
    ...
    @transform_init2cur.setter
    def transform_init2cur(self, value):
        if __debug__:
            from geometry_msgs.msg import PoseStamped
            assert \
