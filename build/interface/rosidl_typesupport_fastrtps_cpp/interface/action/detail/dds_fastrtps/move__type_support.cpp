...
#include "interface/action/detail/move__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const interface::action::Move_Goal & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  interface::action::Move_Goal & ros_message)
{
  // Member: goal_pose
...
{
  auto typed_message =
    static_cast<const interface::action::Move_Goal *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<interface::action::Move_Goal *>(
    untyped_ros_message);
...
{
  return &interface::action::typesupport_fastrtps_cpp::_Move_Goal__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, interface, action, Move_Goal)() {
  return &interface::action::typesupport_fastrtps_cpp::_Move_Goal__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_interface
cdr_serialize(
  const interface::action::Move_Result & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: result_pose
  geometry_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  interface::action::Move_Result & ros_message)
{
  // Member: result_pose
  geometry_msgs::msg::typesupport_fastrtps_cpp::cdr_deserialize(
...
{
  auto typed_message =
    static_cast<const interface::action::Move_Result *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<interface::action::Move_Result *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &interface::action::typesupport_fastrtps_cpp::_Move_Result__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, interface, action, Move_Result)() {
  return &interface::action::typesupport_fastrtps_cpp::_Move_Result__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_interface
cdr_serialize(
  const interface::action::Move_Feedback & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  interface::action::Move_Feedback & ros_message)
{
  // Member: feedback_pose
  geometry_msgs::msg::typesupport_fastrtps_cpp::cdr_deserialize(
...
{
  auto typed_message =
    static_cast<const interface::action::Move_Feedback *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<interface::action::Move_Feedback *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &interface::action::typesupport_fastrtps_cpp::_Move_Feedback__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, interface, action, Move_Feedback)() {
  return &interface::action::typesupport_fastrtps_cpp::_Move_Feedback__handle;
}
...
{
bool cdr_serialize(
  const interface::action::Move_Goal &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
  interface::action::Move_Goal &);
size_t get_serialized_size(
  const interface::action::Move_Goal &,
  size_t current_alignment);
size_t
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_interface
cdr_serialize(
  const interface::action::Move_SendGoal_Request & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: goal_id
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  interface::action::Move_SendGoal_Request & ros_message)
{
  // Member: goal_id
  ...
  size_t current_alignment)
{
  ...
  // Member: goal
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        interface::action::typesupport_fastrtps_cpp::max_serialized_size_Move_Goal(
        full_bounded, current_alignment);
    }
  }
...
{
  auto typed_message =
    static_cast<const interface::action::Move_SendGoal_Request *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<interface::action::Move_SendGoal_Request *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &interface::action::typesupport_fastrtps_cpp::_Move_SendGoal_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, interface, action, Move_SendGoal_Request)() {
  return &interface::action::typesupport_fastrtps_cpp::_Move_SendGoal_Request__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_interface
cdr_serialize(
  const interface::action::Move_SendGoal_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: accepted
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  interface::action::Move_SendGoal_Response & ros_message)
{
  // Member: accepted
  {
    uint8_t tmp;
...
{
  auto typed_message =
    static_cast<const interface::action::Move_SendGoal_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<interface::action::Move_SendGoal_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &interface::action::typesupport_fastrtps_cpp::_Move_SendGoal_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, interface, action, Move_SendGoal_Response)() {
  return &interface::action::typesupport_fastrtps_cpp::_Move_SendGoal_Response__handle;
}
...
{
  return &interface::action::typesupport_fastrtps_cpp::_Move_SendGoal__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, interface, action, Move_SendGoal)() {
  return &interface::action::typesupport_fastrtps_cpp::_Move_SendGoal__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_interface
cdr_serialize(
  const interface::action::Move_GetResult_Request & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: goal_id
  unique_identifier_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  interface::action::Move_GetResult_Request & ros_message)
{
  // Member: goal_id
  unique_identifier_msgs::msg::typesupport_fastrtps_cpp::cdr_deserialize(
    cdr, ros_message.goal_id);
...
{
  auto typed_message =
    static_cast<const interface::action::Move_GetResult_Request *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<interface::action::Move_GetResult_Request *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &interface::action::typesupport_fastrtps_cpp::_Move_GetResult_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, interface, action, Move_GetResult_Request)() {
  return &interface::action::typesupport_fastrtps_cpp::_Move_GetResult_Request__handle;
}
...
{
bool cdr_serialize(
  const interface::action::Move_Result &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
  interface::action::Move_Result &);
size_t get_serialized_size(
  const interface::action::Move_Result &,
  size_t current_alignment);
size_t
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_interface
cdr_serialize(
  const interface::action::Move_GetResult_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: status
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  interface::action::Move_GetResult_Response & ros_message)
{
  // Member: status
  cdr >> ros_message.status;
  ...
  size_t current_alignment)
{
  ...
  // Member: result
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        interface::action::typesupport_fastrtps_cpp::max_serialized_size_Move_Result(
        full_bounded, current_alignment);
    }
  }
...
{
  auto typed_message =
    static_cast<const interface::action::Move_GetResult_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<interface::action::Move_GetResult_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &interface::action::typesupport_fastrtps_cpp::_Move_GetResult_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, interface, action, Move_GetResult_Response)() {
  return &interface::action::typesupport_fastrtps_cpp::_Move_GetResult_Response__handle;
}
...
{
  return &interface::action::typesupport_fastrtps_cpp::_Move_GetResult__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, interface, action, Move_GetResult)() {
  return &interface::action::typesupport_fastrtps_cpp::_Move_GetResult__handle;
}
...
{
bool cdr_serialize(
  const interface::action::Move_Feedback &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
  interface::action::Move_Feedback &);
size_t get_serialized_size(
  const interface::action::Move_Feedback &,
  size_t current_alignment);
size_t
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_interface
cdr_serialize(
  const interface::action::Move_FeedbackMessage & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: goal_id
  unique_identifier_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  interface::action::Move_FeedbackMessage & ros_message)
{
  // Member: goal_id
  unique_identifier_msgs::msg::typesupport_fastrtps_cpp::cdr_deserialize(
    cdr, ros_message.goal_id);
  ...
  size_t current_alignment)
{
  ...
  // Member: feedback
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        interface::action::typesupport_fastrtps_cpp::max_serialized_size_Move_Feedback(
        full_bounded, current_alignment);
    }
  }
...
{
  auto typed_message =
    static_cast<const interface::action::Move_FeedbackMessage *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<interface::action::Move_FeedbackMessage *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &interface::action::typesupport_fastrtps_cpp::_Move_FeedbackMessage__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, interface, action, Move_FeedbackMessage)() {
  return &interface::action::typesupport_fastrtps_cpp::_Move_FeedbackMessage__handle;
}
