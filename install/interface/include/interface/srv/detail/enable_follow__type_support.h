...
#ifndef INTERFACE__SRV__DETAIL__ENABLE_FOLLOW__TYPE_SUPPORT_H_
#define INTERFACE__SRV__DETAIL__ENABLE_FOLLOW__TYPE_SUPPORT_H_
...
#endif  // INTERFACE__SRV__DETAIL__ENABLE_FOLLOW__TYPE_SUPPORT_H_
