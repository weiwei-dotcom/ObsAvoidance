...
bool interface__srv__path_points__request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("interface.srv._path_points.PathPoints_Request", full_classname_dest, 45) == 0);
  }
  interface__srv__PathPoints_Request * ros_message = _ros_message;
  {  // start_position
...
{
  /* NOTE(esteve): Call constructor of PathPoints_Request */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("interface.srv._path_points");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "PathPoints_Request");
...
ROSIDL_GENERATOR_C_EXPORT
bool interface__srv__path_points__response__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("interface.srv._path_points.PathPoints_Response", full_classname_dest, 46) == 0);
  }
  interface__srv__PathPoints_Response * ros_message = _ros_message;
  {  // path_points
...
{
  /* NOTE(esteve): Call constructor of PathPoints_Response */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("interface.srv._path_points");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "PathPoints_Response");
    assert(pymessage_class);
    Py_DECREF(pymessage_module);
    _pymessage = PyObject_CallObject(pymessage_class, NULL);
    Py_DECREF(pymessage_class);
