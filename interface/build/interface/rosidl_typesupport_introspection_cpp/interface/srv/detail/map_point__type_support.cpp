...
{
  new (message_memory) interface::srv::MapPoint_Request(_init);
}

void MapPoint_Request_fini_function(void * message_memory)
{
  auto typed_message = static_cast<interface::srv::MapPoint_Request *>(message_memory);
  typed_message->~MapPoint_Request();
}

static const ::rosidl_typesupport_introspection_cpp::MessageMember MapPoint_Request_message_member_array[1] = {
  {
    "flag",  // name
    ...
    offsetof(interface::srv::MapPoint_Request, flag),  // bytes offset in struct
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers MapPoint_Request_message_members = {
  ...
  1,  // number of fields
  sizeof(interface::srv::MapPoint_Request),
...
{
  return &::interface::srv::rosidl_typesupport_introspection_cpp::MapPoint_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, interface, srv, MapPoint_Request)() {
  return &::interface::srv::rosidl_typesupport_introspection_cpp::MapPoint_Request_message_type_support_handle;
}
...
void MapPoint_Response_init_function(
  void * message_memory, rosidl_runtime_cpp::MessageInitialization _init)
{
  new (message_memory) interface::srv::MapPoint_Response(_init);
}

void MapPoint_Response_fini_function(void * message_memory)
{
  auto typed_message = static_cast<interface::srv::MapPoint_Response *>(message_memory);
  typed_message->~MapPoint_Response();
}

size_t size_function__MapPoint_Response__keypoints(const void * untyped_member)
{
  const auto * member = reinterpret_cast<const std::vector<geometry_msgs::msg::Point32> *>(untyped_member);
  return member->size();
}

const void * get_const_function__MapPoint_Response__keypoints(const void * untyped_member, size_t index)
{
  const auto & member =
...
void * get_function__MapPoint_Response__keypoints(void * untyped_member, size_t index)
{
  auto & member =
...
void resize_function__MapPoint_Response__keypoints(void * untyped_member, size_t size)
{
  auto * member =
    reinterpret_cast<std::vector<geometry_msgs::msg::Point32> *>(untyped_member);
  member->resize(size);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember MapPoint_Response_message_member_array[3] = {
  {
    "point_cloud",  // name
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(interface::srv::MapPoint_Response, point_cloud),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(interface::srv::MapPoint_Response, keypoints),  // bytes offset in struct
    nullptr,  // default value
    size_function__MapPoint_Response__keypoints,  // size() function pointer
    get_const_function__MapPoint_Response__keypoints,  // get_const(index) function pointer
    get_function__MapPoint_Response__keypoints,  // get(index) function pointer
    resize_function__MapPoint_Response__keypoints  // resize(index) function pointer
  },
  {
    "success",  // name
    ::rosidl_typesupport_introspection_cpp::ROS_TYPE_BOOLEAN,  // type
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(interface::srv::MapPoint_Response, success),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers MapPoint_Response_message_members = {
  ...
  3,  // number of fields
  sizeof(interface::srv::MapPoint_Response),
...
{
  return &::interface::srv::rosidl_typesupport_introspection_cpp::MapPoint_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, interface, srv, MapPoint_Response)() {
  return &::interface::srv::rosidl_typesupport_introspection_cpp::MapPoint_Response_message_type_support_handle;
}
...
static ::rosidl_typesupport_introspection_cpp::ServiceMembers MapPoint_service_members = {
  ...
  // see get_service_type_support_handle<interface::srv::MapPoint>()
...
get_service_type_support_handle<interface::srv::MapPoint>()
{
  ...
  auto service_type_support =
    &::interface::srv::rosidl_typesupport_introspection_cpp::MapPoint_service_type_support_handle;
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, interface, srv, MapPoint)() {
  return ::rosidl_typesupport_introspection_cpp::get_service_type_support_handle<interface::srv::MapPoint>();
}
